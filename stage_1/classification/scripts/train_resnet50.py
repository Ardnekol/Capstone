#!/usr/bin/env python3
"""
ResNet-50 Training Script for Waste Classification

Train ResNet-50 on TrashNet dataset and evaluate on both TrashNet and RealWaste.

Usage:
    python train_resnet50.py --epochs 50 --batch 32
"""
...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch_acc > best_acc:
            best_acc = epoch_acc
            torch.save(model.state_dict(), f'results/resnet50_best.pth')
...
def main():
    parser = argparse.ArgumentParser(description='Train ResNet-50 for waste classification')
    ...
    print("Training complete! Results saved to results/resnet50_results.json")
