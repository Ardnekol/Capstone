#!/usr/bin/env python3
"""
Preprocess RealWaste dataset: resize, clean, and organize images for classification.
"""
import os
from PIL import Image

SRC_DIR = '/u/student/2024/cs24mtech11024/Capstone/stage_1/datasets/classification/realwaste/realwaste-main/RealWaste/'
DST_DIR = '/u/student/2024/cs24mtech11024/Capstone/stage_1/datasets/classification/realwaste/dataset-preprocessed/'
IMG_SIZE = (224, 224)

# Automatically detect all class folders in the dataset directory
...
print("RealWaste preprocessing complete. Output in:", DST_DIR)