#!/usr/bin/env python3
"""
U-Net Training Script for Waste Segmentation

Train U-Net on TACO dataset and evaluate on both TACO and BePLi.

Usage:
    python train_unet.py --epochs 100 --batch 8
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train U-Net for waste segmentation')
    ...
    print("Training complete! Results saved to results/unet_results.json")
    print(".4f")
    print(".4f")
    print(".4f")
